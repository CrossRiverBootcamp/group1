...
export class OperationsHistoryComponent implements OnInit {
  ...
  constructor(private _operationsHistoryService: OperationsHistoryService,private _autheticationService :AuthenticationService, private _dialog: MatDialog,
    ) {
     this.accountId = _autheticationService.accountId;
    }
